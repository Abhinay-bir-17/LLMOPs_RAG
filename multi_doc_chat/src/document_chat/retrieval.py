...
class ConversationalRAG:
    """
    This file ASSUMES: “A FAISS index already exists on disk.”
    1️⃣ What ConversationalRAG REALLY is (mentally)
    Think of this class as:
    “A reusable question-answering engine that can talk over a FAISS index.”
    It is session-aware, lazy-loaded, and production-ready.
